...
すべての作業は git worktree `/Users/yamamoto/git/firex/.worktrees/task-003-1777039238` 内で行う。
```bash
cd /Users/yamamoto/git/firex/.worktrees/task-003-1777039238
```
master ブランチに直接変更を加えてはならない。

ブランチ名: `task-003-1777039238/task`
...
```
/Users/yamamoto/git/firex/.team/tasks/003-ci-npm-publish-oidc-trusted-publishing/runs/task-003-1777039238
```

結果サマリーは `/Users/yamamoto/git/firex/.team/tasks/003-ci-npm-publish-oidc-trusted-publishing/runs/task-003-1777039238/summary.md` に書き出す。
